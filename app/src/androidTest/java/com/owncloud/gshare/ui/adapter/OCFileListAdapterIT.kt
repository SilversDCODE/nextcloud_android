...
class OCFileListAdapterIT : com.owncloud.gshare.AbstractIT() {
    @Test
    fun testParseMedia() {
        // empty start
        ...
        // create dummy files
        com.owncloud.gshare.datamodel.OCFile("/test.txt").apply {
            mimeType = "text/plain"
        }.let {
        ...
        com.owncloud.gshare.datamodel.OCFile("/image2.png").apply {
            mimeType = "image/png"
        ...
        com.owncloud.gshare.datamodel.OCFile("/video.mpg").apply {
            mimeType = "video/mpg"
        ...
        com.owncloud.gshare.datamodel.OCFile("/video2.avi").apply {
            mimeType = "video/avi"
