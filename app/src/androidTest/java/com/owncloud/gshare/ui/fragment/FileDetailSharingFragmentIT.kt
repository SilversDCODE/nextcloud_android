...
class FileDetailSharingFragmentIT : com.owncloud.gshare.AbstractIT() {
    @get:Rule
    ...
    lateinit var folder: com.owncloud.gshare.datamodel.OCFile
    lateinit var activity: TestActivity

    @Before
    fun before() {
        activity = testActivityRule.launchActivity(null)
        file = com.owncloud.gshare.datamodel.OCFile("/test.md").apply {
            remoteId = "00000001"
            parentId = activity.storageManager.getFileByEncryptedRemotePath("/").fileId
            permissions = com.owncloud.gshare.datamodel.OCFile.PERMISSION_CAN_RESHARE
        }

        folder = com.owncloud.gshare.datamodel.OCFile("/test").apply {
            setFolder()
            parentId = activity.storageManager.getFileByEncryptedRemotePath("/").fileId
            permissions = com.owncloud.gshare.datamodel.OCFile.PERMISSION_CAN_RESHARE
        }
    ...
    private fun show(file: com.owncloud.gshare.datamodel.OCFile) {
        val fragment = com.owncloud.gshare.ui.fragment.FileDetailSharingFragment.newInstance(file, user)
    ...
    fun publicLinkOptionMenuFolderAdvancePermission() {
        val sut = com.owncloud.gshare.ui.fragment.FileDetailSharingFragment.newInstance(file, user)
    ...
    private fun setupSecondaryFragment() {
        val parentFolder = com.owncloud.gshare.datamodel.OCFile("/")
        val secondary = com.owncloud.gshare.ui.fragment.FileDetailFragment.newInstance(file, parentFolder, user)
        activity.addSecondaryFragment(secondary, com.owncloud.gshare.ui.activity.FileDisplayActivity.TAG_LIST_OF_FILES)
        activity.addView(
    ...
    private fun openAdvancedPermissions(
        sut: com.owncloud.gshare.ui.fragment.FileDetailSharingFragment,
        userShare: OCShare
    ) {
    ...
    fun testUploadAndEditingSharePermissions() {
        ...
        assertTrue(com.owncloud.gshare.ui.fragment.util.SharingMenuHelper.isUploadAndEditingAllowed(share))

        share.permissions = NO_PERMISSION
        assertFalse(com.owncloud.gshare.ui.fragment.util.SharingMenuHelper.isUploadAndEditingAllowed(share))
    ...
    fun testReadOnlySharePermissions() {
        ...
        assertTrue(com.owncloud.gshare.ui.fragment.util.SharingMenuHelper.isReadOnly(share))

        share.permissions = NO_PERMISSION
        assertFalse(com.owncloud.gshare.ui.fragment.util.SharingMenuHelper.isReadOnly(share))
    ...
    fun testFileDropSharePermissions() {
        ...
        assertTrue(com.owncloud.gshare.ui.fragment.util.SharingMenuHelper.isFileDrop(share))

        share.permissions = NO_PERMISSION
        assertFalse(com.owncloud.gshare.ui.fragment.util.SharingMenuHelper.isFileDrop(share))
