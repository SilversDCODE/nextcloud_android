...
internal class SharedListFragmentIT : com.owncloud.gshare.AbstractIT() {
    @get:Rule
    ...
    fun showSharedFiles() {
        ...
        val file = com.owncloud.gshare.datamodel.OCFile("/shared to admin.png").apply {
            remoteId = "00000001"
        ...
        val file1 = com.owncloud.gshare.datamodel.OCFile("/shared to group.png").apply {
            remoteId = "00000001"
            parentId = sut.storageManager.getFileByEncryptedRemotePath("/").fileId
            mimeType = "image/png"
            fileLength = 1024000
        ...
        val file2 = com.owncloud.gshare.datamodel.OCFile("/shared via public link.png").apply {
            remoteId = "00000001"
            parentId = sut.storageManager.getFileByEncryptedRemotePath("/").fileId
            mimeType = "image/png"
            fileLength = 1024000
        ...
        val file3 = com.owncloud.gshare.datamodel.OCFile("/shared to personal circle.png").apply {
            remoteId = "00000001"
            parentId = sut.storageManager.getFileByEncryptedRemotePath("/").fileId
            mimeType = "image/png"
            fileLength = 1024000
        ...
        val file4 = com.owncloud.gshare.datamodel.OCFile("/shared to talk.png").apply {
            remoteId = "00000001"
            parentId = sut.storageManager.getFileByEncryptedRemotePath("/").fileId
            mimeType = "image/png"
            fileLength = 1024000
