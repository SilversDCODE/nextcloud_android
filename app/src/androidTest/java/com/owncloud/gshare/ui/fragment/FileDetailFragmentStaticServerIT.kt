...
class FileDetailFragmentStaticServerIT : com.owncloud.gshare.AbstractIT() {
    @get:Rule
    ...
    fun showFileDetailActivitiesFragment() {
        ...
        sut.addFragment(com.owncloud.gshare.ui.fragment.FileDetailActivitiesFragment.newInstance(file, user))
    ...
    fun showFileDetailSharingFragment() {
        val sut = testActivityRule.launchActivity(null)
        sut.addFragment(com.owncloud.gshare.ui.fragment.FileDetailSharingFragment.newInstance(file, user))
    ...
    fun showDetailsActivities() {
        ...
        val sut = com.owncloud.gshare.ui.fragment.FileDetailFragment.newInstance(file, user, 0)
    ...
    fun showDetailsSharing() {
        val sut = testActivityRule.launchActivity(null)
        sut.addFragment(com.owncloud.gshare.ui.fragment.FileDetailFragment.newInstance(file, user, 1))
