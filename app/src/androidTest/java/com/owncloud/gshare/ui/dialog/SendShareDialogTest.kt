...
class SendShareDialogTest : com.owncloud.gshare.AbstractIT() {
    @get:Rule
    ...
    fun showDialog() {
        ...
        val file = com.owncloud.gshare.datamodel.OCFile("/1.jpg").apply {
            mimeType = "image/jpg"
        }

        val sut = com.owncloud.gshare.ui.dialog.SendShareDialog.newInstance(file, false, OCCapability())
