...
class GalleryFragmentIT : com.owncloud.gshare.AbstractIT() {
    @get:Rule
    ...
    @After
    override fun after() {
        com.owncloud.gshare.datamodel.ThumbnailsCacheManager.clearCache()
    ...
    @Test
    fun showEmpty() {
        val sut = com.owncloud.gshare.ui.fragment.GalleryFragment()
    ...
    private fun createImage(id: Int, width: Int? = null, height: Int? = null) {
        val defaultSize = com.owncloud.gshare.datamodel.ThumbnailsCacheManager.getThumbnailDimension().toFloat()
        val file = com.owncloud.gshare.datamodel.OCFile("/$id.png").apply {
            fileId = id.toLong()
            remoteId = "$id"
            mimeType = "image/png"
        ...
        com.owncloud.gshare.datamodel.ThumbnailsCacheManager.addBitmapToCache(PREFIX_RESIZED_IMAGE + file.remoteId, bitmap)

        assertNotNull(com.owncloud.gshare.datamodel.ThumbnailsCacheManager.getBitmapFromDiskCache(PREFIX_RESIZED_IMAGE + file.remoteId))
