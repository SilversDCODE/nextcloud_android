...
class SetupEncryptionDialogFragmentIT : com.owncloud.gshare.AbstractIT() {
    @get:Rule
    ...
    fun showMnemonic() {
        ...
        val sut = com.owncloud.gshare.ui.dialog.SetupEncryptionDialogFragment.newInstance(user, 0)
