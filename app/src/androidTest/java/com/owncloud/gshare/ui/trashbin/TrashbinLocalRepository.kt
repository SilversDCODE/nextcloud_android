...
class TrashbinLocalRepository(val testCase: TrashbinActivityIT.TestCase) :
    com.owncloud.gshare.ui.trashbin.TrashbinRepository {
    override fun emptyTrashbin(callback: com.owncloud.gshare.ui.trashbin.TrashbinRepository.OperationCallback?) {
        TODO("Not yet implemented")
    }

    override fun restoreFile(file: TrashbinFile?, callback: com.owncloud.gshare.ui.trashbin.TrashbinRepository.OperationCallback?) {
        TODO("Not yet implemented")
    }

    override fun removeTrashbinFile(file: TrashbinFile?, callback: com.owncloud.gshare.ui.trashbin.TrashbinRepository.OperationCallback?) {
        TODO("Not yet implemented")
    }
