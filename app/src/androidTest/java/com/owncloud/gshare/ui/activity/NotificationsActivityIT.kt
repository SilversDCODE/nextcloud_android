...
class NotificationsActivityIT : com.owncloud.gshare.AbstractIT() {
    @get:Rule
    var activityRule = IntentsTestRule(com.owncloud.gshare.ui.activity.NotificationsActivity::class.java, true, false)

    @Test
    @com.owncloud.gshare.utils.ScreenshotTest
    fun empty() {
        val sut: com.owncloud.gshare.ui.activity.NotificationsActivity = activityRule.launchActivity(null)
