...
class OCCapabilityIT : com.owncloud.gshare.AbstractIT() {
    @Test
    fun saveCapability() {
        val fileDataStorageManager =
            com.owncloud.gshare.datamodel.FileDataStorageManager(user, targetContext.contentResolver)
