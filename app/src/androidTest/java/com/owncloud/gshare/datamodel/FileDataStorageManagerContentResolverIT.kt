...
class FileDataStorageManagerContentResolverIT : com.owncloud.gshare.datamodel.FileDataStorageManagerIT() {
    companion object {
        private const val MANY_FILES_AMOUNT = 5000
    }

    override fun before() {
        sut = com.owncloud.gshare.datamodel.FileDataStorageManager(user, targetContext.contentResolver)
        super.before()
    }
    ...
    fun testFolderWithManyFiles() {
        // create folder
        val folderA = com.owncloud.gshare.datamodel.OCFile("/folderA/")
        ...
        val newFiles = (1..MANY_FILES_AMOUNT).map {
            val file = com.owncloud.gshare.datamodel.OCFile("/folderA/file$it")
