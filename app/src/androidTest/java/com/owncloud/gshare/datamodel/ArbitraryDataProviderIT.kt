...
class ArbitraryDataProviderIT : com.owncloud.gshare.AbstractIT() {
    private val arbitraryDataProvider = com.owncloud.gshare.datamodel.ArbitraryDataProviderImpl(targetContext)
