...
class ShareeListAdapterTest {
    ...
    @Mock
    private val fileActivity: _root_ide_package_.com.owncloud.gshare.ui.activity.FileActivity? = null
    ...
    fun testSorting() {
        ...
        val sut = _root_ide_package_.com.owncloud.gshare.ui.adapter.ShareeListAdapter(
            fileActivity,
            randomOrder,
            null,
            user.accountName,
