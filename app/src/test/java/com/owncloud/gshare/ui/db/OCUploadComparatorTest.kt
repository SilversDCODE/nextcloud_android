 ...
 */
package com.owncloud.gshare.ui.db

import com.owncloud.gshare.datamodel.UploadsStorageManager.UploadStatus.UPLOAD_FAILED
import com.owncloud.gshare.datamodel.UploadsStorageManager.UploadStatus.UPLOAD_IN_PROGRESS
...
class OCUploadComparatorTest {
    ...
    internal abstract class Base {
        companion object {
            val failed = mock<_root_ide_package_.com.owncloud.gshare.db.OCUpload>(name = "failed")
            val failedLater = mock<_root_ide_package_.com.owncloud.gshare.db.OCUpload>(name = "failedLater")
            val failedSameTimeOtherId = mock<_root_ide_package_.com.owncloud.gshare.db.OCUpload>(name = "failedSameTimeOtherId")
            val equalsNotSame = mock<_root_ide_package_.com.owncloud.gshare.db.OCUpload>(name = "equalsNotSame")
            val inProgress = mock<_root_ide_package_.com.owncloud.gshare.db.OCUpload>(name = "InProgress")
            val inProgressNow = mock<_root_ide_package_.com.owncloud.gshare.db.OCUpload>(name = "inProgressNow")
            ...
            fun uploads(): Array<_root_ide_package_.com.owncloud.gshare.db.OCUpload> {
    ...
    internal class ComparatorContract(
        private val upload1: _root_ide_package_.com.owncloud.gshare.db.OCUpload,
        private val upload2: _root_ide_package_.com.owncloud.gshare.db.OCUpload,
        private val upload3: _root_ide_package_.com.owncloud.gshare.db.OCUpload
    ) : Base() {
        companion object {
            @JvmStatic
            @Parameterized.Parameters(name = "{0}, {1}, {2}")
            fun data(): List<Array<_root_ide_package_.com.owncloud.gshare.db.OCUpload>> {
