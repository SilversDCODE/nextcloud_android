...
class GalleryAdapterTest {
    ...
    @Mock
    lateinit var ocFileListFragmentInterface: _root_ide_package_.com.owncloud.gshare.ui.interfaces.OCFileListFragmentInterface

    @Mock
    lateinit var preferences: AppPreferences

    @Mock
    lateinit var transferServiceGetter: _root_ide_package_.com.owncloud.gshare.ui.activity.ComponentsGetter
    ...
    fun testItemCount() {
        ...
        val list = listOf(
            GalleryItems(
                1649317247,
                listOf(GalleryRow(listOf(
                    _root_ide_package_.com.owncloud.gshare.datamodel.OCFile("/1.md"),
                    _root_ide_package_.com.owncloud.gshare.datamodel.OCFile("/2.md")
