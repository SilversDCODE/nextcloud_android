...
import com.owncloud.gshare.db.UploadResult;
...
public class UploadsStorageManager extends Observable {
    ...
    public long[] storeUploads(final List<OCUpload> ocUploads) {
        ...
        for (OCUpload ocUpload : ocUploads) {
            final ContentProviderOperation operation = ContentProviderOperation
                .newInsert(ProviderMeta.ProviderTableMeta.CONTENT_URI_UPLOADS)
    ...
    private ContentValues getContentValues(OCUpload ocUpload) {
        ...
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_NAME_COLLISION_POLICY, ocUpload.getNameCollisionPolicy().serialize());
        ...
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_CREATED_BY, ocUpload.getCreatedBy());
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_IS_WHILE_CHARGING_ONLY, ocUpload.isWhileChargingOnly() ? 1 : 0);
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_IS_WIFI_ONLY, ocUpload.isUseWifiOnly() ? 1 : 0);
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_FOLDER_UNLOCK_TOKEN, ocUpload.getFolderUnlockToken());
        return cv;
    }
    ...
    private int updateUploadInternal(Cursor c, UploadStatus status, UploadResult result, String remotePath,
        ...
        while (c.moveToNext()) {
            ...
            String path = c.getString(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_LOCAL_PATH));
            Log_OC.v(
                    TAG,
    ...
    private OCUpload createOCUploadFromCursor(Cursor c) {
        ...
        if (c != null) {
            String localPath = c.getString(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_LOCAL_PATH));
            String remotePath = c.getString(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_REMOTE_PATH));
            String accountName = c.getString(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_ACCOUNT_NAME));
            upload = new OCUpload(localPath, remotePath, accountName);

            upload.setFileSize(c.getLong(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_FILE_SIZE)));
            upload.setUploadId(c.getLong(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta._ID)));
            upload.setUploadStatus(
                    UploadStatus.fromValue(c.getInt(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_STATUS)))
            );
            upload.setLocalAction(c.getInt(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_LOCAL_BEHAVIOUR)));
            upload.setNameCollisionPolicy(NameCollisionPolicy.deserialize(c.getInt(
                    c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_NAME_COLLISION_POLICY))));
            upload.setCreateRemoteFolder(c.getInt(
                    c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_IS_CREATE_REMOTE_FOLDER)) == 1);
            upload.setUploadEndTimestamp(c.getLong(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_UPLOAD_END_TIMESTAMP)));
            upload.setLastResult(UploadResult.fromValue(
                    c.getInt(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT))));
            upload.setCreatedBy(c.getInt(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_CREATED_BY)));
            upload.setUseWifiOnly(c.getInt(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_IS_WIFI_ONLY)) == 1);
            upload.setWhileChargingOnly(c.getInt(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_IS_WHILE_CHARGING_ONLY))
                    == 1);
            upload.setFolderUnlockToken(c.getString(c.getColumnIndexOrThrow(ProviderMeta.ProviderTableMeta.UPLOADS_FOLDER_UNLOCK_TOKEN)));
        }
        return upload;
    }
    ...
    public OCUpload[] getCurrentAndPendingUploadsForAccount(final @NonNull String accountName) {
        return getUploads(ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "==" + UploadStatus.UPLOAD_IN_PROGRESS.value +
                              " OR " + ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT +
                              ...
                              " AND " + ProviderMeta.ProviderTableMeta.UPLOADS_ACCOUNT_NAME + "== ?",
                          accountName);
    }
    ...
    public List<OCUpload> getCurrentAndPendingUploadsForAccountPageAscById(final long afterId, final @NonNull String accountName) {
        final String selection = ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "==" + UploadStatus.UPLOAD_IN_PROGRESS.value +
            " OR " + ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT +
            "==" + UploadResult.DELAYED_FOR_WIFI.getValue() +
            " OR " + ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT +
            "==" + UploadResult.LOCK_FAILED.getValue() +
    ...
    public OCUpload[] getFailedUploads() {
        return getUploads("(" + ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "== ?" +
                              " OR " + ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT +
                              "==" + UploadResult.DELAYED_FOR_WIFI.getValue() +
                              " OR " + ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT +
                              "==" + UploadResult.LOCK_FAILED.getValue() +
                              ...
                              " OR " + ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT +
                              "==" + UploadResult.DELAYED_IN_POWER_SAVE_MODE.getValue() +
                              " ) AND " + ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT +
    ...
    public OCUpload[] getFinishedUploadsForCurrentAccount() {
        ...
        return getUploads(ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "==" + UploadStatus.UPLOAD_SUCCEEDED.value + AND +
                              ProviderMeta.ProviderTableMeta.UPLOADS_ACCOUNT_NAME + "== ?", user.getAccountName());
    }
    ...
    public OCUpload[] getFinishedUploads() {
        ...
        return getUploads(ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "==" + UploadStatus.UPLOAD_SUCCEEDED.value, (String[]) null);
    }

    public OCUpload[] getFailedButNotDelayedUploadsForCurrentAccount() {
        User user = currentAccountProvider.getUser();

        return getUploads(ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "==" + UploadStatus.UPLOAD_FAILED.value +
                        AND + ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT +
                        "<>" + UploadResult.DELAYED_FOR_WIFI.getValue() +
                        AND + ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT +
                        "<>" + UploadResult.LOCK_FAILED.getValue() +
    ...
    public OCUpload[] getFailedButNotDelayedUploads() {
        ...
        return getUploads(ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "==" + UploadStatus.UPLOAD_FAILED.value + AND +
                        ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT + "<>" + UploadResult.LOCK_FAILED.getValue() +
                        AND + ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT +
                        "<>" + UploadResult.DELAYED_FOR_WIFI.getValue() +
                        AND + ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT +
                        "<>" + UploadResult.DELAYED_FOR_CHARGING.getValue() +
    ...
    public long clearFailedButNotDelayedUploads() {
        ...
        final long deleted = getDB().delete(
                ProviderMeta.ProviderTableMeta.CONTENT_URI_UPLOADS,
                ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "==" + UploadStatus.UPLOAD_FAILED.value +
                        AND + ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT +
                        "<>" + UploadResult.LOCK_FAILED.getValue() +
                        AND + ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT +
                        "<>" + UploadResult.DELAYED_FOR_WIFI.getValue() +
    ...
    public long clearSuccessfulUploads() {
        ...
        final long deleted = getDB().delete(
                ProviderMeta.ProviderTableMeta.CONTENT_URI_UPLOADS,
                ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "==" + UploadStatus.UPLOAD_SUCCEEDED.value + AND +
                        ProviderMeta.ProviderTableMeta.UPLOADS_ACCOUNT_NAME + "== ?", new String[]{user.getAccountName()}
        );
