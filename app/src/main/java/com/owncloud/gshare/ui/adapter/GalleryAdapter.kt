...
import com.owncloud.gshare.ui.fragment.GalleryFragmentBottomSheetDialog
...
class GalleryAdapter(
    val context: Context,
    user: User,
    ocFileListFragmentInterface: _root_ide_package_.com.owncloud.gshare.ui.interfaces.OCFileListFragmentInterface,
    preferences: AppPreferences,
    transferServiceGetter: _root_ide_package_.com.owncloud.gshare.ui.activity.ComponentsGetter,
    ...
    private var storageManager: _root_ide_package_.com.owncloud.gshare.datamodel.FileDataStorageManager
    ...
    override fun getPopupText(position: Int): String {
        return _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.getDateByPattern(
            files[getRelativePosition(position).section()].date,
            context,
            _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.MONTH_YEAR_PATTERN
        )
    }
    ...
    override fun onBindHeaderViewHolder(holder: SectionedViewHolder?, section: Int, expanded: Boolean) {
        if (holder != null) {
            ...
            headerViewHolder.binding.month.text = _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.getDateByPattern(
                galleryItem.date,
                context,
                _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.MONTH_PATTERN
            )
            headerViewHolder.binding.year.text = _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.getDateByPattern(
                galleryItem.date,
                context,
    ...
    fun showAllGalleryItems(
        ...
        photoFragment: _root_ide_package_.com.owncloud.gshare.ui.fragment.GalleryFragment
    ) {
    ...
    private fun setMediaFilter(
        items: List<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile>,
        mediaState: GalleryFragmentBottomSheetDialog.MediaState,
        photoFragment: _root_ide_package_.com.owncloud.gshare.ui.fragment.GalleryFragment
    ) {
        val finalSortedList: List<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile> = when (mediaState) {
            GalleryFragmentBottomSheetDialog.MediaState.MEDIA_STATE_PHOTOS_ONLY -> {
                items.filter { _root_ide_package_.com.owncloud.gshare.utils.MimeTypeUtil.isImage(it.mimeType) }.distinct()
            }
            GalleryFragmentBottomSheetDialog.MediaState.MEDIA_STATE_VIDEOS_ONLY -> {
                items.filter { _root_ide_package_.com.owncloud.gshare.utils.MimeTypeUtil.isVideo(it.mimeType) }.distinct()
            }
            else -> items
        }
    ...
    private fun transformToRows(list: List<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile>): List<GalleryRow> {
        return list
    ...
    fun getItem(position: Int): _root_ide_package_.com.owncloud.gshare.datamodel.OCFile? {
    ...
    override fun getItemPosition(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile): Int {
    ...
    override fun setHighlightedItem(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile) {
        TODO("Not yet implemented")
    }

    override fun setSortOrder(mFile: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile, sortOrder: FileSortOrder) {
        TODO("Not yet implemented")
    }

    override fun addCheckedFile(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile) {
        ocFileListDelegate.addCheckedFile(file)
    }

    override fun isCheckedFile(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile): Boolean {
        return ocFileListDelegate.isCheckedFile(file)
    }

    override fun getCheckedItems(): Set<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile> {
        return ocFileListDelegate.checkedItems
    }

    override fun removeCheckedFile(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile) {
        ocFileListDelegate.removeCheckedFile(file)
    }

    override fun notifyItemChanged(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile) {
