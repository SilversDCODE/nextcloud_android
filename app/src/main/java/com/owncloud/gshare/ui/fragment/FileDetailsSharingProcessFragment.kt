...
import com.owncloud.gshare.databinding.FileDetailsSharingProcessFragmentBinding
...
class FileDetailsSharingProcessFragment :
    Fragment(),
    Injectable,
    _root_ide_package_.com.owncloud.gshare.ui.dialog.ExpirationDatePickerDialogFragment.OnExpiryDateListener {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun newInstance(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile, shareeName: String, shareType: ShareType): FileDetailsSharingProcessFragment {
            val args = Bundle()
    ...
    private lateinit var onEditShareListener: _root_ide_package_.com.owncloud.gshare.ui.fragment.FileDetailSharingFragment.OnEditShareListener

    private lateinit var binding: FileDetailsSharingProcessFragmentBinding
    private var fileOperationsHelper: _root_ide_package_.com.owncloud.gshare.ui.helpers.FileOperationsHelper? = null
    private var fileActivity: _root_ide_package_.com.owncloud.gshare.ui.activity.FileActivity? = null

    private var file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile? = null // file to be share
    ...
    private var expirationDatePickerFragment: _root_ide_package_.com.owncloud.gshare.ui.dialog.ExpirationDatePickerDialogFragment? = null

    override fun onAttach(context: Context) {
        super.onAttach(context)
        try {
            onEditShareListener = context as _root_ide_package_.com.owncloud.gshare.ui.fragment.FileDetailSharingFragment.OnEditShareListener
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fileActivity = activity as _root_ide_package_.com.owncloud.gshare.ui.activity.FileActivity?
    ...
    private fun setupModificationUI() {
        ...
        if (_root_ide_package_.com.owncloud.gshare.ui.fragment.util.SharingMenuHelper.isUploadAndEditingAllowed(share)) {
            binding.shareProcessPermissionUploadEditing.isChecked = true
        } else if (_root_ide_package_.com.owncloud.gshare.ui.fragment.util.SharingMenuHelper.isFileDrop(share) && share?.isFolder == true) {
            binding.shareProcessPermissionFileDrop.isChecked = true
        } else if (_root_ide_package_.com.owncloud.gshare.ui.fragment.util.SharingMenuHelper.isReadOnly(share)) {
    ...
    private fun updateViewForShareType() {
        ...
        // internal share
            ...
            if (share != null) {
                ...
                binding.shareProcessAllowResharingCheckbox.isChecked = _root_ide_package_.com.owncloud.gshare.ui.fragment.util.SharingMenuHelper.canReshare(share)
            }
        }
    }
    ...
    private fun updateViewForExternalAndLinkShare() {
        ...
        if (share != null) {
            if (_root_ide_package_.com.owncloud.gshare.ui.fragment.util.SharingMenuHelper.isFileDrop(share)) {
                binding.shareProcessHideDownloadCheckbox.visibility = View.GONE
            } else {
                binding.shareProcessHideDownloadCheckbox.visibility = View.VISIBLE
    ...
    private fun showExpirationDateDialog(chosenDateInMillis: Long = chosenExpDateInMills) {
        val dialog = _root_ide_package_.com.owncloud.gshare.ui.dialog.ExpirationDatePickerDialogFragment.newInstance(chosenDateInMillis)
        dialog.setOnExpiryDateListener(this)
        expirationDatePickerFragment = dialog
        fileActivity?.let {
            dialog.show(
                it.supportFragmentManager,
                _root_ide_package_.com.owncloud.gshare.ui.dialog.ExpirationDatePickerDialogFragment.DATE_PICKER_DIALOG
            )
        }
    }
    ...
    private fun validateShareProcessFirst() {
        ...
        if (permission == OCShare.NO_PERMISSION) {
            _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.showSnackMessage(binding.root, R.string.no_share_permission_selected)
            return
        }
        ...
        if (binding.shareProcessSetPasswordSwitch.isChecked &&
            ...
            _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.showSnackMessage(binding.root, R.string.share_link_empty_password)
            return
        }
        ...
        if (binding.shareProcessChangeNameSwitch.isChecked &&
            ...
            _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.showSnackMessage(binding.root, R.string.label_empty)
            return
        }
    ...
    private fun updateShare() {
        ...
        if (!TextUtils.isEmpty(share?.shareLink)) {
            _root_ide_package_.com.owncloud.gshare.utils.ClipboardUtil.copyToClipboard(activity, share?.shareLink)
        }
    }
