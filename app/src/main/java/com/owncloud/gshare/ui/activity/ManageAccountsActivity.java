...
import static com.owncloud.gshare.ui.activity.UserInfoActivity.KEY_USER_DATA;
import static com.owncloud.gshare.ui.adapter.UserListAdapter.KEY_DISPLAY_NAME;
import static com.owncloud.gshare.ui.adapter.UserListAdapter.KEY_USER_INFO_REQUEST_CODE;
...
public class ManageAccountsActivity extends FileActivity implements UserListAdapter.Listener,
    ...
    private void openAccount(User user) {
        ...
        intent.putExtra(UserListAdapter.KEY_DISPLAY_NAME, oca.getDisplayName());
