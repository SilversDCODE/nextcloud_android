...
class UriUploader(
    private val mActivity: _root_ide_package_.com.owncloud.gshare.ui.activity.FileActivity,
    ...
    private fun requestUpload(localPath: String?, remotePath: String) {
        _root_ide_package_.com.owncloud.gshare.files.services.FileUploader.uploadNewFile(
            mActivity,
            user,
            localPath,
            remotePath,
            ...
            _root_ide_package_.com.owncloud.gshare.operations.UploadFileOperation.CREATED_BY_USER,
            false,
            false,
            _root_ide_package_.com.owncloud.gshare.files.services.NameCollisionPolicy.ASK_USER
        )
    }
    ...
    private fun copyThenUpload(sourceUris: Array<Uri>, remotePaths: Array<String>) {
        ...
        val copyTask = _root_ide_package_.com.owncloud.gshare.ui.asynctasks.CopyAndUploadContentUrisTask(
            mCopyTmpTaskListener,
            mActivity
        )
        ...
        val taskRetainerFragment =
            fm.findFragmentByTag(_root_ide_package_.com.owncloud.gshare.ui.fragment.TaskRetainerFragment.FTAG_TASK_RETAINER_FRAGMENT) as _root_ide_package_.com.owncloud.gshare.ui.fragment.TaskRetainerFragment?
        taskRetainerFragment?.setTask(copyTask)
        copyTask.execute(
            *_root_ide_package_.com.owncloud.gshare.ui.asynctasks.CopyAndUploadContentUrisTask.makeParamsToExecute(
                user,
                sourceUris,
                remotePaths,
                mBehaviour,
