...
class PreviewPdfFragment : Fragment(), Injectable {
    ...
    private lateinit var file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile): PreviewPdfFragment = PreviewPdfFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.showSnackMessage(binding.root, R.string.pdf_password_protected)
        }
    }
    ...
    private fun setupObservers() {
        ...
        viewModel.shouldShowZoomTip.observe(viewLifecycleOwner) { shouldShow ->
            if (shouldShow) {
                snack = _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.showSnackMessage(binding.root, R.string.pdf_zoom_tip)
    ...
    override fun onResume() {
        super.onResume()
        val parent = activity
        if (parent is _root_ide_package_.com.owncloud.gshare.ui.activity.FileDisplayActivity) {
