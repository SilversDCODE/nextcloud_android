...
object OCShareToOCFileConverter {
     ...
     */
    @JvmStatic
    fun buildOCFilesFromShares(shares: List<OCShare>): List<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile> {
    ...
    private fun buildOcFile(path: String, shares: List<OCShare>): _root_ide_package_.com.owncloud.gshare.datamodel.OCFile {
        require(shares.all { it.path == path })
        // common attributes
        val firstShare = shares.first()
        val file = _root_ide_package_.com.owncloud.gshare.datamodel.OCFile(path).apply {
