...
class TextEditorWebView : _root_ide_package_.com.owncloud.gshare.ui.activity.EditorWebView() {
    ...
    @Inject
    lateinit var themeUtils: _root_ide_package_.com.owncloud.gshare.utils.theme.ThemeUtils
    ...
    override fun loadUrl(url: String?) {
        if (url.isNullOrEmpty()) {
            _root_ide_package_.com.owncloud.gshare.ui.asynctasks.TextEditorLoadUrlTask(
                this,
                user.get(),
                file,
                editorUtils
