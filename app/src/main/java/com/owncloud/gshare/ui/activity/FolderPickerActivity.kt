...
import com.owncloud.gshare.syncadapter.FileSyncAdapter
import com.owncloud.gshare.ui.dialog.CreateFolderDialogFragment
import com.owncloud.gshare.ui.dialog.SortingOrderDialogFragment.OnSortingOrderListener
...
open class FolderPickerActivity :
    ...
    _root_ide_package_.com.owncloud.gshare.ui.fragment.FileFragment.ContainerActivity,
    View.OnClickListener,
    _root_ide_package_.com.owncloud.gshare.ui.activity.OnEnforceableRefreshListener,
    Injectable,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (this is _root_ide_package_.com.owncloud.gshare.ui.activity.FilePickerActivity) {
    ...
    override fun onActionModeStarted(mode: ActionMode) {
        ...
        if (account != null) {
            ...
            if (folder == null || !folder.isFolder) {
                ...
                file = storageManager.getFileByPath(_root_ide_package_.com.owncloud.gshare.datamodel.OCFile.ROOT_PATH)
                folder = file
            }
    ...
    protected open fun createFragments() {
        val listOfFiles = _root_ide_package_.com.owncloud.gshare.ui.fragment.OCFileListFragment()
        val args = Bundle()
        args.putBoolean(_root_ide_package_.com.owncloud.gshare.ui.fragment.OCFileListFragment.ARG_ONLY_FOLDERS_CLICKABLE, true)
        args.putBoolean(_root_ide_package_.com.owncloud.gshare.ui.fragment.OCFileListFragment.ARG_HIDE_FAB, true)
        args.putBoolean(_root_ide_package_.com.owncloud.gshare.ui.fragment.OCFileListFragment.ARG_HIDE_ITEM_OPTIONS, true)
        args.putBoolean(_root_ide_package_.com.owncloud.gshare.ui.fragment.OCFileListFragment.ARG_SEARCH_ONLY_FOLDER, mSearchOnlyFolders)
    ...
    protected val listOfFilesFragment: _root_ide_package_.com.owncloud.gshare.ui.fragment.OCFileListFragment?
        protected get() {
            val listOfFiles = supportFragmentManager.findFragmentByTag(TAG_LIST_OF_FOLDERS)
            if (listOfFiles != null) {
                return listOfFiles as _root_ide_package_.com.owncloud.gshare.ui.fragment.OCFileListFragment?
            }
     ...
     */
    override fun onBrowsedDownTo(directory: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile) {
        file = directory
        updateUiElements()
        // Sync Folder
    ...
    private fun startSyncFolderOperation(folder: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile?, ignoreETag: Boolean) {
        val currentSyncTime = System.currentTimeMillis()
        mSyncInProgress = true

        // perform folder synchronization
        val refreshFolderOperation: RemoteOperation<*> =
            _root_ide_package_.com.owncloud.gshare.operations.RefreshFolderOperation(
                folder,
                currentSyncTime,
                false,
                ignoreETag,
    ...
    override fun onResume() {
        ...
        val syncIntentFilter = IntentFilter(_root_ide_package_.com.owncloud.gshare.syncadapter.FileSyncAdapter.EVENT_FULL_SYNC_START)
        syncIntentFilter.addAction(_root_ide_package_.com.owncloud.gshare.syncadapter.FileSyncAdapter.EVENT_FULL_SYNC_END)
        syncIntentFilter.addAction(_root_ide_package_.com.owncloud.gshare.syncadapter.FileSyncAdapter.EVENT_FULL_SYNC_FOLDER_CONTENTS_SYNCED)
        syncIntentFilter.addAction(_root_ide_package_.com.owncloud.gshare.operations.RefreshFolderOperation.EVENT_SINGLE_FOLDER_CONTENTS_SYNCED)
        syncIntentFilter.addAction(_root_ide_package_.com.owncloud.gshare.operations.RefreshFolderOperation.EVENT_SINGLE_FOLDER_SHARES_SYNCED)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (itemId == R.id.action_create_dir) {
            val dialog = _root_ide_package_.com.owncloud.gshare.ui.dialog.CreateFolderDialogFragment.newInstance(currentFolder)
            dialog.show(supportFragmentManager, _root_ide_package_.com.owncloud.gshare.ui.dialog.CreateFolderDialogFragment.CREATE_FOLDER_FRAGMENT)
    ...
    val currentFolder: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile?
        get() {
            val currentFile = file
            var finalFolder: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile? = null
            ...
            if (currentFile != null) {
                ...
                finalFolder = storageManager.getFileByPath(_root_ide_package_.com.owncloud.gshare.datamodel.OCFile.ROOT_PATH)
            }
            return finalFolder
        }
    ...
    fun browseToRoot() {
        ...
        if (listOfFiles != null) {
            ...
            val root = storageManager.getFileByPath(_root_ide_package_.com.owncloud.gshare.datamodel.OCFile.ROOT_PATH)
    ...
    override fun onRemoteOperationFinish(operation: RemoteOperation<*>?, result: RemoteOperationResult<*>) {
        ...
        if (operation is _root_ide_package_.com.owncloud.gshare.operations.CreateFolderOperation) {
    ...
    private fun onCreateFolderOperationFinish(
        operation: _root_ide_package_.com.owncloud.gshare.operations.CreateFolderOperation,
        ...
        if (result.isSuccess) {
            ...
            try {
                _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.showSnackMessage(
                    this,
                    _root_ide_package_.com.owncloud.gshare.utils.ErrorMessageAdapter.getErrorCauseMessage(result, operation, resources)
                )
    ...
    private inner class SyncBroadcastReceiver : BroadcastReceiver() {
        ...
        override fun onReceive(context: Context, intent: Intent) {
            try {
                ...
                val accountName = intent.getStringExtra(_root_ide_package_.com.owncloud.gshare.syncadapter.FileSyncAdapter.EXTRA_ACCOUNT_NAME)
                val syncFolderRemotePath = intent.getStringExtra(_root_ide_package_.com.owncloud.gshare.syncadapter.FileSyncAdapter.EXTRA_FOLDER_PATH)
                val syncResult = _root_ide_package_.com.owncloud.gshare.utils.DataHolderUtil.getInstance()
                    .retrieve(intent.getStringExtra(_root_ide_package_.com.owncloud.gshare.syncadapter.FileSyncAdapter.EXTRA_RESULT)) as RemoteOperationResult<*>
                val sameAccount = account != null && accountName == account.name && storageManager != null
                if (sameAccount) {
                    if (_root_ide_package_.com.owncloud.gshare.syncadapter.FileSyncAdapter.EVENT_FULL_SYNC_START == event) {
                        mSyncInProgress = true
                    } else {
                        ...
                        mSyncInProgress = _root_ide_package_.com.owncloud.gshare.syncadapter.FileSyncAdapter.EVENT_FULL_SYNC_END != event &&
                            _root_ide_package_.com.owncloud.gshare.operations.RefreshFolderOperation.EVENT_SINGLE_FOLDER_SHARES_SYNCED != event
                        if (_root_ide_package_.com.owncloud.gshare.operations.RefreshFolderOperation.EVENT_SINGLE_FOLDER_CONTENTS_SYNCED == event && !syncResult.isSuccess
                        ) {
                    ...
                    _root_ide_package_.com.owncloud.gshare.utils.DataHolderUtil.getInstance().delete(intent.getStringExtra(
                        _root_ide_package_.com.owncloud.gshare.syncadapter.FileSyncAdapter.EXTRA_RESULT))
    ...
    override fun showDetails(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile) {
        // not used at the moment
    }

    override fun showDetails(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile, activeTab: Int) {
        // not used at the moment
    }
     ...
     * {@inheritDoc}
     */
    override fun onTransferStateChanged(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile, downloading: Boolean, uploading: Boolean) {
        // not used at the moment
    }
