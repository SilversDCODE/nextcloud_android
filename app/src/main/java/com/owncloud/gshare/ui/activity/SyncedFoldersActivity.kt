...
class SyncedFoldersActivity :
    _root_ide_package_.com.owncloud.gshare.ui.activity.FileActivity(),
    _root_ide_package_.com.owncloud.gshare.ui.adapter.SyncedFolderAdapter.ClickListener,
    ...
    companion object {
        ...
        fun sortSyncedFolderItems(syncFolderItemList: List<_root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem?>): List<_root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem?> {
    ...
    private lateinit var adapter: _root_ide_package_.com.owncloud.gshare.ui.adapter.SyncedFolderAdapter

    private var syncedFolderPreferencesDialogFragment: _root_ide_package_.com.owncloud.gshare.ui.dialog.SyncedFolderPreferencesDialogFragment? = null
    ...
    private fun setupContent() {
        ...
        adapter = _root_ide_package_.com.owncloud.gshare.ui.adapter.SyncedFolderAdapter(
            this,
            clock,
            gridWidth,
            this,
        ...
        binding.list.addItemDecoration(
            _root_ide_package_.com.owncloud.gshare.ui.decoration.MediaGridItemDecoration(
                spacing
            )
        )
    ...
    private fun load(perFolderMediaItemLimit: Int, force: Boolean) {
        ...
        loadJob = CoroutineScope(Dispatchers.IO).launch {
            loadJob?.cancel()
            val mediaFolders = _root_ide_package_.com.owncloud.gshare.datamodel.MediaProvider.getImageFolders(
                contentResolver,
            ...
            mediaFolders.addAll(
                _root_ide_package_.com.owncloud.gshare.datamodel.MediaProvider.getVideoFolders(
                    contentResolver,
                    perFolderMediaItemLimit,
                    this@SyncedFoldersActivity,
                    false,
            ...
            val currentAccountSyncedFoldersList: MutableList<_root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolder> = ArrayList()
    ...
    private fun mergeFolderData(
        syncedFolders: List<_root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolder>,
        mediaFolders: List<_root_ide_package_.com.owncloud.gshare.datamodel.MediaFolder>
    ): List<_root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem?> {
        val syncedFoldersMap = createSyncedFoldersMap(syncedFolders)
        val result: MutableList<_root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem?> = ArrayList()
        for (mediaFolder in mediaFolders) {
            if (syncedFoldersMap.containsKey(mediaFolder.absolutePath + "-" + mediaFolder.type)) {
                ...
                if (syncedFolder != null && SyncedFolderUtils.isQualifyingMediaFolder(syncedFolder)) {
                    if (_root_ide_package_.com.owncloud.gshare.datamodel.MediaFolderType.CUSTOM == syncedFolder.type) {
    ...
    private fun createSyncedFolderWithoutMediaFolder(syncedFolder: _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolder): _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem {
        ...
        return _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem(
            syncedFolder.id,
     ...
     */
    private fun createSyncedFolder(syncedFolder: _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolder, mediaFolder: _root_ide_package_.com.owncloud.gshare.datamodel.MediaFolder): _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem {
        return _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem(
            syncedFolder.id,
            syncedFolder.localPath,
            syncedFolder.remotePath,
     ...
     * @return the created SyncedFolderDisplayItem
     */
    private fun createSyncedFolderFromMediaFolder(mediaFolder: _root_ide_package_.com.owncloud.gshare.datamodel.MediaFolder): _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem {
        return _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem(
            _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolder.UNPERSISTED_ID,
            ...
            false,
            account.name,
            _root_ide_package_.com.owncloud.gshare.files.services.FileUploader.LOCAL_BEHAVIOUR_FORGET,
            _root_ide_package_.com.owncloud.gshare.files.services.NameCollisionPolicy.ASK_USER.serialize(),
            false,
            clock.currentTime,
            mediaFolder.filePaths,
            mediaFolder.folderName,
     ...
     */
    private fun createSyncedFoldersMap(syncFolders: List<_root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolder>?): MutableMap<String, _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolder> {
        val result: MutableMap<String, _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolder> = HashMap()
        if (syncFolders != null) {
        ...
        when (item.itemId) {
            ...
            R.id.action_create_custom_folder -> {
                ...
                if (PermissionUtil.checkExternalStoragePermission(this)) {
                    val emptyCustomFolder = _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem(
                        _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolder.UNPERSISTED_ID,
                        null,
                        null,
                        true,
                        ...
                        clock.currentTime,
                        null,
                        _root_ide_package_.com.owncloud.gshare.datamodel.MediaFolderType.CUSTOM,
                        false
                    )
    ...
    override fun onSyncStatusToggleClick(section: Int, syncedFolderDisplayItem: _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem) {
        if (syncedFolderDisplayItem.id > _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolder.UNPERSISTED_ID) {
    ...
    override fun onSyncFolderSettingsClick(section: Int, syncedFolderDisplayItem: _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem) {
        val fm = supportFragmentManager
        val ft = fm.beginTransaction()
        ft.addToBackStack(null)
        syncedFolderPreferencesDialogFragment = _root_ide_package_.com.owncloud.gshare.ui.dialog.SyncedFolderPreferencesDialogFragment.newInstance(
    ...
    override fun onVisibilityToggleClick(section: Int, syncedFolder: _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem) {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (requestCode == _root_ide_package_.com.owncloud.gshare.ui.dialog.SyncedFolderPreferencesDialogFragment.REQUEST_CODE__SELECT_REMOTE_FOLDER &&
            resultCode == RESULT_OK && syncedFolderPreferencesDialogFragment != null
        ) {
            val chosenFolder: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile = data!!.getParcelableExtra(FolderPickerActivity.EXTRA_FOLDER)!!
            syncedFolderPreferencesDialogFragment!!.setRemoteFolderSummary(chosenFolder.remotePath)
        } else if (
            requestCode == _root_ide_package_.com.owncloud.gshare.ui.dialog.SyncedFolderPreferencesDialogFragment.REQUEST_CODE__SELECT_LOCAL_FOLDER &&
            resultCode == RESULT_OK && syncedFolderPreferencesDialogFragment != null
        ) {
            val localPath = data!!.getStringExtra(_root_ide_package_.com.owncloud.gshare.ui.activity.UploadFilesActivity.EXTRA_CHOSEN_FILES)
    ...
    override fun onSaveSyncedFolderPreference(syncedFolder: _root_ide_package_.com.owncloud.gshare.ui.dialog.parcel.SyncedFolderParcelable) {
        // custom folders newly created aren't in the list already,
        // so triggering a refresh
        if (_root_ide_package_.com.owncloud.gshare.datamodel.MediaFolderType.CUSTOM == syncedFolder.type && syncedFolder.id == _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolder.UNPERSISTED_ID) {
            val newCustomFolder = _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem(
                _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolder.UNPERSISTED_ID,
                syncedFolder.localPath,
                syncedFolder.remotePath,
                syncedFolder.isWifiOnly,
    ...
    private fun saveOrUpdateSyncedFolder(item: _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem) {
        if (item.id == _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolder.UNPERSISTED_ID) {
            ...
            if (item.isEnabled) {
                ...
                val arbitraryDataProvider =
                    _root_ide_package_.com.owncloud.gshare.datamodel.ArbitraryDataProviderImpl(MainApp.getAppContext())
                arbitraryDataProvider.deleteKeyForAccount("global", syncedFolderInitiatedKey)
            }
        }
    }

    private fun storeSyncedFolder(item: _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem) {
        val arbitraryDataProvider =
            _root_ide_package_.com.owncloud.gshare.datamodel.ArbitraryDataProviderImpl(MainApp.getAppContext())
    ...
    override fun onDeleteSyncedFolderPreference(syncedFolder: _root_ide_package_.com.owncloud.gshare.ui.dialog.parcel.SyncedFolderParcelable) {
        syncedFolderProvider.deleteSyncedFolder(syncedFolder.id)
    ...
    private fun updateSyncedFolderItem(
        item: _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderDisplayItem,
        id: Long,
        localPath: String,
        remotePath: String,
        wifiOnly: Boolean,
            ...
            val alertDialogBuilder = AlertDialog.Builder(this, R.style.Theme_ownCloud_Dialog)
                ...
                .setPositiveButton(getString(R.string.battery_optimization_disable)) { _, _ ->
                    ...
                    val intent = Intent(
                        ...
                        Uri.parse("package:" + _root_ide_package_.com.owncloud.gshare.BuildConfig.APPLICATION_ID)
                    )
    ...
    private fun checkIfBatteryOptimizationEnabled(): Boolean {
        ...
        return when {
            powerManager != null -> !powerManager.isIgnoringBatteryOptimizations(_root_ide_package_.com.owncloud.gshare.BuildConfig.APPLICATION_ID)
            else -> true
        }
    }
}
