...
import com.owncloud.gshare.databinding.ChooseTemplateBinding
...
import com.owncloud.gshare.ui.activity.TextEditorWebView
 ...
 */
class ChooseTemplateDialogFragment : DialogFragment(), View.OnClickListener, _root_ide_package_.com.owncloud.gshare.ui.adapter.TemplateAdapter.ClickListener, Injectable {
    ...
    @Inject
    lateinit var fileDataStorageManager: _root_ide_package_.com.owncloud.gshare.datamodel.FileDataStorageManager
    ...
    private var adapter: _root_ide_package_.com.owncloud.gshare.ui.adapter.TemplateAdapter? = null
    private var parentFolder: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile? = null
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        adapter = _root_ide_package_.com.owncloud.gshare.ui.adapter.TemplateAdapter(
            creator!!.mimetype,
            this,
            context,
            currentAccount,
    ...
    override fun onClick(v: View) {
        ...
        if (selectedTemplate == null) {
            _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.showSnackMessage(binding.list, R.string.select_one_template)
        } else if (name.isEmpty() || name.equals(DOT + selectedTemplate.extension, ignoreCase = true)) {
            _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.showSnackMessage(binding.list, R.string.enter_filename)
    ...
    private class CreateFileFromTemplateTask(
        ...
        private var file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile? = null
        ...
        override fun doInBackground(vararg params: Void): String {
            return try {
                ...
                val context = fragment.context
                    ...
                    return ""
                val storageManager = _root_ide_package_.com.owncloud.gshare.datamodel.FileDataStorageManager(
                    user,
                    context.contentResolver
                )
                val temp = _root_ide_package_.com.owncloud.gshare.utils.FileStorageUtils.fillOCFile(newFileResult.data[0] as RemoteFile)
        ...
        override fun onPostExecute(url: String) {
            ...
            if (fragment != null && fragment.isAdded) {
                if (url.isEmpty()) {
                    _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.showSnackMessage(fragment.binding.list, R.string.error_creating_file_from_template)
                } else {
                    val editorWebView = Intent(_root_ide_package_.com.owncloud.gshare.MainApp.getAppContext(), TextEditorWebView::class.java)
                    editorWebView.putExtra(_root_ide_package_.com.owncloud.gshare.ui.activity.ExternalSiteWebView.EXTRA_TITLE, "Text")
                    editorWebView.putExtra(_root_ide_package_.com.owncloud.gshare.ui.activity.ExternalSiteWebView.EXTRA_URL, url)
                    editorWebView.putExtra(_root_ide_package_.com.owncloud.gshare.ui.activity.ExternalSiteWebView.EXTRA_FILE, file)
                    editorWebView.putExtra(_root_ide_package_.com.owncloud.gshare.ui.activity.ExternalSiteWebView.EXTRA_SHOW_SIDEBAR, false)
        ...
        override fun onPostExecute(templateList: TemplateList) {
            ...
            if (fragment != null && fragment.isAdded) {
                if (templateList.templates.isEmpty()) {
                    _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.showSnackMessage(fragment.binding.list, R.string.error_retrieving_templates)
                } else {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(parentFolder: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile?, creator: Creator?, headline: String?): ChooseTemplateDialogFragment {
