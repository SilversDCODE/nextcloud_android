...
class UnifiedSearchViewModel(application: Application) : AndroidViewModel(application), IUnifiedSearchViewModel {
    ...
    override val file = MutableLiveData<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile>()
    ...
    fun openFile(fileUrl: String) {
        if (isLoading.value == false) {
            ...
            val task = GetRemoteFileTask(
                ...
                _root_ide_package_.com.owncloud.gshare.datamodel.FileDataStorageManager(user, context.contentResolver),
                user
            )
