...
import com.owncloud.gshare.databinding.BackupFragmentBinding;
...
import static com.owncloud.gshare.ui.activity.ContactsPreferenceActivity.PREFERENCE_CONTACTS_LAST_BACKUP;
...
public class BackupFragment extends FileFragment implements DatePickerDialog.OnDateSetListener, Injectable {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // display last backup
        Long lastBackupTimestamp = arbitraryDataProvider.getLongValue(user, ContactsPreferenceActivity.PREFERENCE_CONTACTS_LAST_BACKUP);
