...
class GalleryRowHolder(
    ...
    fun bind(row: GalleryRow) {
        ...
        while (binding.rowLayout.childCount < row.files.size) {
            ...
            val imageView = ImageView(context).apply {
                setImageDrawable(
                    _root_ide_package_.com.owncloud.gshare.datamodel.ThumbnailsCacheManager.AsyncGalleryImageDrawable(
                        context.resources,
                        _root_ide_package_.com.owncloud.gshare.utils.BitmapUtils.drawableToBitmap(
    ...
    private fun computeShrinkRatio(row: GalleryRow): Float {
        val screenWidth =
            _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.convertDpToPixel(context.resources.configuration.screenWidthDp.toFloat(), context)
                .toFloat()
    ...
    private fun adjustFile(indexedFile: IndexedValue<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile>, shrinkRatio: Float, row: GalleryRow) {
