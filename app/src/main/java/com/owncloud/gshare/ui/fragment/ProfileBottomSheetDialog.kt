...
class ProfileBottomSheetDialog(
...
) : BottomSheetDialog(fileActivity), _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.AvatarGenerationListener {
    ...
    private fun openWebsite(url: String) {
        _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.startLinkIntent(fileActivity, url)
    }
    ...
    private fun sendEmail(email: String) {
        ...
        _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.startIntentIfAppAvailable(intent, fileActivity, R.string.no_email_app_available)
    }
