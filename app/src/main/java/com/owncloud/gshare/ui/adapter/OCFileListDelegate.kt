...
class OCFileListDelegate(
    ...
    private val ocFileListFragmentInterface: _root_ide_package_.com.owncloud.gshare.ui.interfaces.OCFileListFragmentInterface,
    private val user: User,
    private val storageManager: _root_ide_package_.com.owncloud.gshare.datamodel.FileDataStorageManager,
    private val hideItemOptions: Boolean,
    private val preferences: AppPreferences,
    private val gridView: Boolean,
    private val transferServiceGetter: _root_ide_package_.com.owncloud.gshare.ui.activity.ComponentsGetter,
    private val showMetadata: Boolean,
    private var showShareAvatar: Boolean,
    private var viewThemeUtils: ViewThemeUtils,
    private val syncFolderProvider: _root_ide_package_.com.owncloud.gshare.datamodel.SyncedFolderProvider? = null
) {
    private val checkedFiles: MutableSet<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile> = HashSet()
    private var highlightedItem: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile? = null
    var isMultiSelect = false
    private val asyncTasks: MutableList<_root_ide_package_.com.owncloud.gshare.datamodel.ThumbnailsCacheManager.ThumbnailGenerationTask> = ArrayList()
    private val asyncGalleryTasks: MutableList<_root_ide_package_.com.owncloud.gshare.datamodel.ThumbnailsCacheManager.GalleryImageGenerationTask> = ArrayList()
    fun setHighlightedItem(highlightedItem: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile?) {
    ...
    fun addToCheckedFiles(files: List<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile>?) {
        checkedFiles.addAll(files!!)
    }

    val checkedItems: Set<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile>
        get() = checkedFiles

    fun setCheckedItem(files: Set<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile>?) {
        checkedFiles.clear()
        checkedFiles.addAll(files!!)
    }
    ...
    private fun setGalleryImage(
        ...
        if (_root_ide_package_.com.owncloud.gshare.datamodel.ThumbnailsCacheManager.cancelPotentialThumbnailWork(file, thumbnailView)) {
            ...
            try {
                val task = _root_ide_package_.com.owncloud.gshare.datamodel.ThumbnailsCacheManager.GalleryImageGenerationTask(
                    thumbnailView,
                    user,
                    storageManager,
                    asyncGalleryTasks,
                ...
                var drawable = _root_ide_package_.com.owncloud.gshare.utils.MimeTypeUtil.getFileTypeIcon(
                    file.mimeType,
                    file.fileName,
                    context,
                    viewThemeUtils
                ...
                val thumbnail = _root_ide_package_.com.owncloud.gshare.utils.BitmapUtils.drawableToBitmap(drawable, width / 2, width / 2)
                val asyncDrawable = _root_ide_package_.com.owncloud.gshare.datamodel.ThumbnailsCacheManager.AsyncGalleryImageDrawable(
                    context.resources,
                    thumbnail,
                    task
                )
                if (shimmerThumbnail != null) {
                    ...
                    _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.startShimmer(shimmerThumbnail, thumbnailView)
                }
                task.setListener(object : GalleryListener {
                    override fun onSuccess() {
                        galleryRowHolder.binding.rowLayout.invalidate()
                        Log_OC.d("Shimmer", "stop Shimmer")
                        _root_ide_package_.com.owncloud.gshare.utils.DisplayUtils.stopShimmer(shimmerThumbnail, thumbnailView)
                    }
    ...
    fun bindGridViewHolder(
        ...
        val shouldHideShare = gridView ||
            ...
            file.isEncrypted && !_root_ide_package_.com.owncloud.gshare.utils.EncryptionUtils.supportsSecureFiledrop(file, user) ||
    ...
    private fun bindUnreadComments(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile, gridViewHolder: ListGridImageViewHolder) {
    ...
    private fun bindGridItemLayout(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile, gridViewHolder: ListGridImageViewHolder) {
    ...
    private fun bindGridMetadataViews(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile, gridViewHolder: ListGridImageViewHolder) {
        if (showMetadata) {
    ...
    private fun showLocalFileIndicator(file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile, gridViewHolder: ListGridImageViewHolder) {
    ...
    private fun showShareIcon(gridViewHolder: ListGridImageViewHolder, file: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile) {
