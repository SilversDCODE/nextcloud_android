...
class OCFileListSearchAsyncTask(
    containerActivity: _root_ide_package_.com.owncloud.gshare.ui.fragment.FileFragment.ContainerActivity,
    fragment: _root_ide_package_.com.owncloud.gshare.ui.fragment.OCFileListFragment,
    private val remoteOperation: RemoteOperation<List<Any>>,
    private val currentUser: User,
    private val event: SearchEvent
) : AsyncTask<Void, Void, Boolean>() {
    private val activityReference: WeakReference<_root_ide_package_.com.owncloud.gshare.ui.fragment.FileFragment.ContainerActivity> = WeakReference(containerActivity)
    private val fragmentReference: WeakReference<_root_ide_package_.com.owncloud.gshare.ui.fragment.OCFileListFragment> = WeakReference(fragment)

    private val fileDataStorageManager: _root_ide_package_.com.owncloud.gshare.datamodel.FileDataStorageManager?
