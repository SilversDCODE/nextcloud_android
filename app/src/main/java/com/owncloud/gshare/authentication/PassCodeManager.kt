 ...
 *
 */
package com.owncloud.gshare.authentication
...
class PassCodeManager(private val preferences: AppPreferences, private val clock: Clock) {
    companion object {
        private val exemptOfPasscodeActivities = setOf(
            _root_ide_package_.com.owncloud.gshare.ui.activity.PassCodeActivity::class.java,
            _root_ide_package_.com.owncloud.gshare.ui.activity.RequestCredentialsActivity::class.java
        )
    ...
    private fun requestPasscode(activity: Activity) {
        val i = Intent(_root_ide_package_.com.owncloud.gshare.MainApp.getAppContext(), _root_ide_package_.com.owncloud.gshare.ui.activity.PassCodeActivity::class.java)
        i.action = _root_ide_package_.com.owncloud.gshare.ui.activity.PassCodeActivity.ACTION_CHECK
        i.flags = Intent.FLAG_ACTIVITY_SINGLE_TOP
        activity.startActivityForResult(i, PASSCODE_ACTIVITY)
    }

    private fun requestCredentials(activity: Activity) {
        val i = Intent(_root_ide_package_.com.owncloud.gshare.MainApp.getAppContext(), _root_ide_package_.com.owncloud.gshare.ui.activity.RequestCredentialsActivity::class.java)
        i.flags = Intent.FLAG_ACTIVITY_SINGLE_TOP
        activity.startActivityForResult(i, PASSCODE_ACTIVITY)
    }
    ...
    private fun isPassCodeEnabled(): Boolean = _root_ide_package_.com.owncloud.gshare.ui.activity.SettingsActivity.LOCK_PASSCODE == preferences.lockPreference
    ...
    private fun deviceCredentialsAreEnabled(activity: Activity): Boolean {
        return _root_ide_package_.com.owncloud.gshare.ui.activity.SettingsActivity.LOCK_DEVICE_CREDENTIALS == preferences.lockPreference ||
            (preferences.isFingerprintUnlockEnabled && _root_ide_package_.com.owncloud.gshare.utils.DeviceCredentialUtils.areCredentialsAvailable(activity))
    }
