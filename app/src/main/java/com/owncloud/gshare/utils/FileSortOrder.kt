...
open class FileSortOrder(@JvmField var name: String, var isAscending: Boolean) {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun sortCloudFilesByFavourite(files: MutableList<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile>): List<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile> {
            files.sortWith { o1: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile, o2: _root_ide_package_.com.owncloud.gshare.datamodel.OCFile ->
                when {
    ...
    open fun sortCloudFiles(files: MutableList<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile>): List<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile> {
