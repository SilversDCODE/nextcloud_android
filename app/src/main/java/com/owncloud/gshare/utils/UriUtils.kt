...
object UriUtils {
    ...
    private fun getDisplayNameColumnForMimeType(mimeType: String?) = when {
        _root_ide_package_.com.owncloud.gshare.utils.MimeTypeUtil.isImage(mimeType) -> {
            MediaStore.Images.ImageColumns.DISPLAY_NAME
        }
        _root_ide_package_.com.owncloud.gshare.utils.MimeTypeUtil.isVideo(mimeType) -> {
            MediaStore.Video.VideoColumns.DISPLAY_NAME
        }
        _root_ide_package_.com.owncloud.gshare.utils.MimeTypeUtil.isAudio(mimeType) -> {
