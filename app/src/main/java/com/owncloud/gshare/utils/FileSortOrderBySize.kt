...
class FileSortOrderBySize internal constructor(name: String?, ascending: Boolean) : FileSortOrder(name!!, ascending) {
    ...
    override fun sortCloudFiles(files: MutableList<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile>): List<_root_ide_package_.com.owncloud.gshare.datamodel.OCFile> {
    ...
    override fun sortLocalFiles(files: MutableList<File>): List<File> {
        files.sortWith { o1: File, o2: File ->
            when {
                o1.isDirectory && o2.isDirectory -> sortMultiplier * _root_ide_package_.com.owncloud.gshare.utils.FileStorageUtils.getFolderSize(o1)
                    .compareTo(_root_ide_package_.com.owncloud.gshare.utils.FileStorageUtils.getFolderSize(o2))
                o1.isDirectory -> -1
                o2.isDirectory -> 1
