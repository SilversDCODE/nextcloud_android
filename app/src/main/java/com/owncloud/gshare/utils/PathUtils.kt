...
object PathUtils {
    ...
    fun isAncestor(folderPath: String, filePath: String): Boolean {
        ...
        val folderPathWithSlash =
            if (folderPath.endsWith(_root_ide_package_.com.owncloud.gshare.datamodel.OCFile.PATH_SEPARATOR)) folderPath else folderPath + _root_ide_package_.com.owncloud.gshare.datamodel.OCFile.PATH_SEPARATOR
